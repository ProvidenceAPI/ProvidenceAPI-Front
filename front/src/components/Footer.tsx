        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              ...
              <span className="block mt-1">Unite a la revolución Providence hoy mismo.</span>
            </p>

            {/* Redes Sociales */}
            <div className="space-y-4">
              <h4 className="text-white font-semibold text-sm uppercase tracking-wider">Seguinos</h4>
          ...
          <div>
            <div className="mb-6 pb-2 border-b border-gray-800">
              <h3 className="text-white font-bold text-lg tracking-tight">Navegación</h3>
            </div>
            ...
            <ul className="space-y-4 text-gray-300">
              <li className="group flex items-start gap-3 hover:text-white transition-colors duration-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">Lunes a Sábado 7:00-22:00</p>
                </div>
              </li>
              ...
              <li className="group flex items-start gap-3 hover:text-white transition-colors duration-200">
                ...
                <div>
                  <p className="text-sm font-medium">info@providencefitness.com</p>
                  <p className="text-xs text-gray-500 mt-0.5">Respondemos en 24h</p>
                </div>
              </li>
              ...
              <li className="group flex items-start gap-3 hover:text-white transition-colors duration-200">
                ...
                <div>
                  <p className="text-sm font-medium">Provincia de Buenos Aires 760</p>
                  <p className="text-xs text-gray-500 mt-0.5">Cipoletti, Argentina</p>
                </div>
              </li>
            </ul>
