...
export default function RegisterForm() {
  ...
  const [validations, setValidations] =
    useState<ValidationRules>(initialValidations);
  ...
  const validateRealTime = useCallback(() => {
    ...
    if (registerForm.phone) {
      ...
      newValidations.phone = phoneRegex.test(
  ...
  const changeHandler = (
    ...
    setRegisterForm((prev) => ({
      ...prev,
      [property]:
        property === "dni" ? (value ? parseInt(value, 10) : 0) : value,
    }));
        ...
        <div className="max-w-md mx-auto w-full text-center">
          ...
          <form onSubmit={submitHandler} className="space-y-6" noValidate>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.name ? "text-red-600" : "text-black"}`}
                >
                  NOMBRE (3-80 caracteres)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.name ? "text-red-500" : validations.name ? "text-green-500" : "text-gray-400"}`}
                  >
                    {validations.name ? "✓" : "👤"}
                  </span>
                  <input
              ...
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.lastname ? "text-red-600" : "text-black"}`}
                >
                  APELLIDO (3-80 caracteres)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.lastname ? "text-red-500" : validations.lastname ? "text-green-500" : "text-gray-400"}`}
                  >
            ...
            <div>
              <label
                className={`block text-sm font-semibold mb-2 ${errors.email ? "text-red-600" : "text-black"}`}
              >
                CORREO ELECTRÓNICO
                {emailChecking && (
              ...
              <div className="relative">
                <span
                  className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.email ? "text-red-500" : validations.email ? "text-green-500" : "text-gray-400"}`}
                >
                  {validations.email ? "✓" : "✉️"}
                </span>
                <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.dni ? "text-red-600" : "text-black"}`}
                >
                  DNI (7-10 dígitos)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.dni ? "text-red-500" : validations.dni ? "text-green-500" : "text-gray-400"}`}
                  >
                    {validations.dni ? "✓" : "🆔"}
                  </span>
                  <input
              ...
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.phone ? "text-red-600" : "text-black"}`}
                >
                  TELÉFONO (10-15 dígitos)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.phone ? "text-red-500" : validations.phone ? "text-green-500" : "text-gray-400"}`}
                  >
                    {validations.phone ? "✓" : "📱"}
                  </span>
                  <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.genre ? "text-red-600" : "text-black"}`}
                >
                  GÉNERO
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.genre ? "text-red-500" : validations.genre ? "text-green-500" : "text-gray-400"}`}
                  >
                    {validations.genre ? "✓" : "⚤"}
                  </span>
                  <select
              ...
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.birthdate ? "text-red-600" : "text-black"}`}
                >
                  FECHA DE NACIMIENTO (Mínimo 16 años)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.birthdate ? "text-red-500" : validations.birthdate ? "text-green-500" : "text-gray-400"}`}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.password ? "text-red-600" : "text-black"}`}
                >
                  CONTRASEÑA (8-15 caracteres)
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.password ? "text-red-500" : validations.password ? "text-green-500" : "text-gray-400"}`}
                  >
                    ...
                    {registerForm.password.length > 0 && (
                      <>
                        <div className="flex items-center justify-between">
                          <span
                            className={`text-sm ${getPasswordStrength(registerForm.password).color}`}
                          >
                            Seguridad:{" "}
                            {getPasswordStrength(registerForm.password).text}
                          </span>
                          <span
                            className={`text-sm ${registerForm.password.length < 8 ? "text-red-500" : registerForm.password.length > 15 ? "text-red-500" : "text-green-600"}`}
                          >
                            {registerForm.password.length}/15
                          </span>
                        </div>
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          <div
                            className={`flex items-center ${/[a-z]/.test(registerForm.password) ? "text-green-600" : "text-gray-400"}`}
                          >
                            <span className="mr-1">
                          ...
                          <div
                            className={`flex items-center ${/\d/.test(registerForm.password) ? "text-green-600" : "text-gray-400"}`}
                          >
                            <span className="mr-1">
                          ...
                          <div
                            className={`flex items-center ${/[!@#$%^&*]/.test(registerForm.password) ? "text-green-600" : "text-gray-400"}`}
                          >
                            <span className="mr-1">
              ...
              <div>
                <label
                  className={`block text-sm font-semibold mb-2 ${errors.confirmPassword ? "text-red-600" : "text-black"}`}
                >
                  CONFIRMAR CONTRASEÑA
                </label>
                <div className="relative">
                  <span
                    className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${errors.confirmPassword ? "text-red-500" : validations.confirmPassword ? "text-green-500" : "text-gray-400"}`}
                  >
