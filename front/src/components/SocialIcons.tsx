...
export const FacebookIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
...
export const InstagramIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
...
export const TwitterIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
...
export const WhatsAppIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
...
// Contact icons (phone, mail, location) - outlined
export const PhoneIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
...
export const MailIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
...
export const LocationIcon = ({ className = "w-5 h-5", ...props }: SocialIconProps) => (
	<svg className={className} viewBox="0 0 24 24" {...commonProps} {...props}>
