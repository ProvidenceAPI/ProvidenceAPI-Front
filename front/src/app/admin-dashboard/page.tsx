...
export default function AdminDashboard() {
  const { user, isAuthenticated, isAdmin, isSuperAdmin, loading, logout } = useAppContext();
...
╚═══════════════════════════════════════════════════════
  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          <p className="text-gray-600 text-lg">Sin permisos de administrador...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-3xl font-semibold text-gray-900">$12,450</dd>
                </dl>
              </div>
            </div>
          </div>
