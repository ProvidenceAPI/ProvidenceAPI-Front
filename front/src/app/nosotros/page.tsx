      ...
      <div className="bg-white text-black min-h-screen">
        ...
        <section className="py-24 md:py-32 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 px-6 items-center">
            <div className="space-y-8">
              <div>
                <span className="text-red-600 font-bold text-lg tracking-wider">PROVIDENCE FITNESS</span>
              ...
              <div className="space-y-6">
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                  <span className="text-gray-900 font-semibold">Providence Fitness</span> nace de entrenadores y atletas que creen que el fitness no es solo transpirar, sino progresar de verdad.
                </p>
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                  Creamos un espacio donde cada persona recibe <span className="text-gray-900 font-semibold">atención real, estructura y acompañamiento constante</span>. No somos una cadena, somos tu equipo.
                </p>
              </div>
              
              <div className="flex items-center gap-4 pt-4">
                <div className="w-12 h-0.5 bg-red-600"></div>
                <span className="text-gray-500 text-sm tracking-wider">DESDE 2025</span>
              </div>
            </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-red-600/30">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white text-sm tracking-wider">ENTRENAMIENTO ESTRUCTURADO</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Descubrí la experiencia completa a través de nuestros espacios, entrenamientos y comunidad.
              </p>
            </div>
        ...
        <section className="py-24 md:py-32 bg-gradient-to-b from-white to-red-50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <span className="text-red-600 font-bold text-lg tracking-wider">NUESTRO PROPÓSITO</span>
              <h2 className="text-4xl md:text-5xl font-black mt-2 mb-6 text-gray-900">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="bg-white rounded-2xl p-8 border border-red-600/20 shadow-lg">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  ...
                  Brindar herramientas físicas y mentales que trascienden el gimnasio.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-red-600/20 shadow-lg">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  Ser la comunidad fitness de referencia donde cada miembro logra 
                  sus objetivos personales a través de metodología, dedicación y soporte real.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { title: "EXCELENCIA", desc: "En cada entrenamiento y seguimiento" },
                  { title: "COMUNIDAD", desc: "Apoyo real entre miembros" },
                  { title: "DISCIPLINA", desc: "Consistencia sobre intensidad" },
                  { title: "INNOVACIÓN", desc: "Métodos actualizados constantemente" },
                  { title: "PASIÓN", desc: "Amor por el proceso, no solo los resultados" },
                  { title: "RESPONSABILIDAD", desc: "Compromiso con tu transformación" },
                ].map((valor, index) => (
                  <div 
                    key={index}
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="font-bold text-lg text-red-600">{valor.title}</h4>
                    </div>
