  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        html: `
          <div class="text-left">
            <p>Se ha creado exitosamente el ${formData.role === "superadmin" ? "⭐ Super Administrador" : "Administrador"}:</p>
            <div class="mt-4 p-3 bg-gray-100 rounded-lg">
              <p><strong>Nombre:</strong> ${formData.name} ${formData.lastname}</p>
              <p><strong>Email:</strong> ${formData.email}</p>
              <p><strong>Rol:</strong> ${formData.role === "superadmin" ? "⭐ Super Admin" : "Admin"}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <ol className="text-sm text-blue-700 space-y-1 list-decimal pl-5">
                ...
                <li>Se actualiza su rol a Administrador</li>
